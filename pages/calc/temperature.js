  ...
  return (
    ...
    >
      ...
      {loading ? (
        ...
        data &&
        labels && (
          <Chart data={data} labels={labels} fromZero={false} title={"Daily Temperature Power"} />
        )
      )}
...
const dailyText = "Daily temperature in (° Ceclius in 2 meter) gives an idea about how temperature changes in daily basis in your locality. Temperature affects the generation of solar enery. You can interact real time with data from NASA API by changing location and time range."
const monthlyText = "Monthly temperature (° Celcius in 2 meter) gives an idea about last 5 years monthly data. You can take descition about your solar energy and temperature from previous data. This data is powered by NASA and based on your selected location. If an error is generated make sure the time range is valid and try again by reloading."
const yearlyText = "This dataset (° Celcius 2 meter) is generated according to the climatological temperature from 1990. It shows a clear picture about temperature in the basis of long term. This data is fetched from NASA and based on your selected location If an error is generated make sure the time range is valid and try again by reloading."